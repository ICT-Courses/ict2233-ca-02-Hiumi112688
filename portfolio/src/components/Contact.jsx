...
const Contact = () => {
  return (
    <div className="bg-black text-white py-20 bg-black dark:bg-gray-900 text-white " id="contact">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            ...
            <div className="mb-4 mt-8">
              ...
              <a
                href="mailto:hiumimihinadi@gmail.com"
            ...
            <div className="mb-4">
              ...
              <span>+94703076334</span>
            </div>

            <div className="mb-4">
              <FaMapMarkedAlt className="inline-block text-green-400 mr-2" />
              <span>Pallewela, Western Province, Sri Lanka</span>
            </div>
          </div>
          ...
          <div className="flex-1 w-full">
            <form className="space-y-4">
              <div>
                <label htmlFor="name" className='block mb-2'>YourName</label>
                <input type="text"
